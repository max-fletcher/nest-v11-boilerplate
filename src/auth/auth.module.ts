...
// NOTE: To use auth using passport js, you need 3 things:
// 1. A Strategy 2. A Guard 3. Correct export and imports
// Step 1: Make a strategy with a name(we used 'access-token-jwt' here)
// Step 2: Make a guard with matching name(we used 'access-token-jwt' here)
// Step 3: Import, export and add to providers the following: PassportModule, JwtModule.register and AccessTokenStrategy in the auth module
